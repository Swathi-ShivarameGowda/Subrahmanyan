    ...
    return (
        <>
            ...
            <div className="container" >
                ...
                <div className="earlylifepara" >Singavadivel et al, 1981 (41) showed that there was very heavy breakage of rice from paddy that had become wet during the rains. This breakage was prevented when the paddy was  mixed with a mixture of husk powder and salt.</div>
                <br></br>
                ...
                <br></br>
                <div className="earlylifepara" >During parboiling paddy is usually soaked for at room temperature for 2-3 days or at 65oC for a ferw hours. There is is about 3% loss of solids during the soaking process. The matter that is released causes either for fermentation to occur during the soaking period itself and imparts  malodour to the rice . Even when heated water is used for soaking some matter gets into the effluent and must be treated.The  odour that appears on prolonged soaking could be eliminated  when  an oxygen donating substance, such as chromate or hypochlorite is used. There was a resulting increase in the yield of brown rice obtained from such paddy by 1.4-2.9% (22)</div>
                ...
                <div>
                        ...
                        <br></br><br></br>
                        <div className="earlylifepara" >Sand heated with husk  to 120-130oC could dry the paddy at 20-29% moisture in 5-6 minutes. The sand could be sieved off and reheated prior to reuse as a drying agent, Iengar et al, (10). Another sand parboiling method developed concurrent parboiling and drying of soaked paddy occurs when paddy mixed with hot sand at 150oC for 36 seconds in sand roaster. The used sand was  sieved and reheated in the reversed screw conveyor and again mixed with soaked paddy. (56).</div>
                        <br></br><br></br><br></br><br></br>
                </div>
                
                <div className="earlylife" style={{ fontSize: 'larger' }} >Short Soaking and Tempering Process</div>
                <br></br>
                <div className="earlylifepara" >Pillaiyar et al (57) reported the use of a hot soaking and  tempering step (HSST method) to bring the moisture content of soaked paddy to about 25%  and for uniform distribution of moisture throughout the grain.  This, the “tempering” step was best carried out in insulated vessels. The paddy was then steamed for ten minutes for the parboiling. This method saved energy by 30% by reducing the drying time. Pillaiyar et al. (59) devised a method  parboiling of paddy that had been presteamed and soaked in water for 12 hour with hot sand at about 120oC. The rice thus processed was similar to that prepared from soaked and atmospheric pressure steamed paddy. These workers suggest that when the temperature of sand was taken to 250oC the rice cooked showed all the properties that it had been precooked. The use of such rice to make instant rice soji was suggested. (57)</div>
                <br></br>
