    ...
    return (
        <>
            ...
            <div className="container" >
                ...
                <br></br>
                <div className="earlylifepara" >During parboiling paddy is usually soaked for at room temperature for 2-3 days or at 65{'\u00b0'}C for a ferw hours. There is is about 3% loss of solids during the soaking process. The matter that is released causes either for fermentation to occur during the soaking period itself and imparts  malodour to the rice . Even when heated water is used for soaking some matter gets into the effluent and must be treated.The  odour that appears on prolonged soaking could be eliminated  when  an oxygen donating substance, such as chromate or hypochlorite is used. There was a resulting increase in the yield of brown rice obtained from such paddy by 1.4-2.9% (22)</div>
