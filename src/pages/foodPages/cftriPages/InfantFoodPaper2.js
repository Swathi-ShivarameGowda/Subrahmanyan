    ...
    return (
        <>
            ...
            <div className="container" >
                <br></br>
                <div className="earlylife" style={{ fontSize: 'large' }} >Shelf life of the spray dried product paper<font size="1">12</font></div>
                <br></br>
                <div className="earlylifepara" >Their criteria as was in their reference paper that of solubility of the product on reconstitution, the palatability, shelf life, presence of off odor, and the need to eliminate oxygen during storage of the spray dried product. Leah et al 19435 had also warned that presence of copper as was possible with copper vessel stored milk, could increase the intensity of off flavor produced in milk powder during storage. Infant food was prepared as above when milk was collected in sterilized stainless steel (and chilled) or aluminum vessels (three hours to reach laboratory). Milk containing straw and milk stored in copper vessels was also used to make the infant food. The food was packed in air or in the presence of nitrogen using an apparatus similar to that described in Leah et al 1943 (5). A Haldane apparatus was used to measure carbon di oxide and oxygen. The figure given below is from an unrelated publication but illustrates the nature of the apparatus. </div>
                <br></br>
                ...
                <div className="earlylifepara" >The Haldane apparatus was used to measure the oxygen content in the tins as it varied with processing conditions and time. The samples of infant food prepared from milk obtained in stainless or aluminum cans during collection had the least peroxide values and highest palatability score using the least oxygen during storage. These samples were acceptable even when stored at 37oC instead of at room temperature (25-29 oC) for eight months under nitrogen. At room temperature the infant food was acceptable even after 16 months.12</div>
                <br></br>
