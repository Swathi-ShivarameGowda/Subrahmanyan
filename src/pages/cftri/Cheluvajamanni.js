    ...
    return (
        <>
            ...
            <div className="container" >
                ...
                <br></br>
                <div className='referencepara'>(1).http://www.indiandefencereview.com/origin-of-cavalry-in-indian-army-and-the-silladar-system/ (2) Electrical World  (1911)  58:  471 https://www.google.com/books/edition/Electrical_World/TOBQAAAAYAAJ?hl=en&gbpv=1&dq=Mr.+Beams+chief+electrical+engineer+mysore&pg=PA471&printsec=frontcover (3) Maconchie ,Evan(1926)  Life in the Indian Civil Service Chapman and Hill (https://archive.org/details/in.ernet.dli.2015.276694). (4)  Selections from the records of the Mysore Palace. Volume 2. Palaces and Mansions of the Royal Family. (2009) Karnataka State Archives  Department, Government of Karnataka. (5) Parsons, Constance E,Mysore City  (1930)   Humphery Milford Oxford University Press. (6)  Desikacharya ,N. (1949) “The Origin and Growth of Sri Bramhatantra Parakala Mutt” The Bangalore Press, Mysore Road,Bangalore. https://archive.org/details/in.gov.ignca.7352/page/n531/mode/2up (7). https://www.ykcwadiyar.in/blog. (8). A Jathre To Remember (wordpress.com).</div>
                <br></br>
                <div className='referencepara'>Thanks are due to Mr.Rajachandra, He has been a tremendous source of authentic information and always prompt with answers to our questions. Thanks are due Mr Sridhar Raj and  Bharathi Urs   for launching me in the path the article has taken. Our debt to the Mysore archives is large.  Photos of the palace is from N. Niranjan Nikam, Star of Mysore Sunday 18 April 2021 </div>
                <br></br>
