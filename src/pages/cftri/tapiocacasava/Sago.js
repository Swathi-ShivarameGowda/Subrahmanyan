    ...
    return (
        <>
            ...
            <div className="container" >
                ...
                <br></br>
                <div className="earlylifepara" >Visakham Thirunal Rama Varma (1837 – 1885) is credited with bringing Tapioca to Kerala (<a href="https://www.thehindu.com/life-and-style/food/how-tapioca-came-to-travancore/article28181288.ece" target="_blank" style={{ textDecoration: 'none' }} ><font color="#3819e9">https://www.thehindu.com/life-and-style/food/how-tapioca-came-to-travancore/article28181288.ece</font></a>.)  Subrahmanyan (1952) writes about the role of tapioca in avoiding famine in Kerala. During 1951 and 1952, there was severe drought in Karnataka and the author urged people in the state of Mysore to take up Tapioca cultivation. He also wrote about how renumerative the production of sago was in Salem  “It has been reported by the Famine Commission that in 1943 the food-grain position in Travancore was even worse than in Bengal. It was tapioca  that saved the people of Travancore” (1). </div>
                <br></br>
