...
export default function ProcessContinued2() {
    ...
    return (
        <>
            ...
            <div className="container" >
                ...
                <br></br>
                <div className="earlylifepara" >The series of papers (21,23,24) on manufacture using the roller drying process begin with a description of large scale manufacturing that was accomplished in using the roller driers at the Healthway company at Varanasi while milk was obtained from a cooperative dairy (for supply of Buffalo Milk). The papers begins with differentiating the two processes and states that for scale and solubility of product the spray drying method was better while for flexibility in scale and keeping quality the roller dried method was superior</div>
                <br></br>
                <img className="infantfoodcontinued" src={babyfood6} />
                <br></br>
                <div className="earlylifepara" >Chandrasekahara,et al 1960(22) reported much better shelf-life  than the spray dried product as gauged by organoleptic scores and thiobarbituric acid values. A shelf-life of 10months at 37oc was extrapolated to an expected shelf life of 20 months at room temperature. There was  degradation of thiamine of 15% at room temperature stored samples and 25% in that stored at 37oC. Degradation of thiamine was somewhat higher in Samples containing added iron than those without.</div>
                <br></br>
                ...
                <div className="earlylife" style={{ fontSize: 'large' }} >Devlopment of Humaized Buffalo Infant Food : Other Approaches</div>
                <br></br>
                ...
                <div className="earlylifepara" >Singh, 1982 (34)  formulated a spray dried infant based on milk whey (made by adding rennet). Whey and milk were mixed , warmed, electrodialysed and  homogenised. (This was carried out to increase the lactoglobulin component relative to casein and to decrease the calcium levels in buffalo milk). Similarly cream sperated from milk was homogenized and blended with coconut,. Groundnut and palm  oils. Whey was sterilised , inocluated with B.bifidus. Post homogenization, -lactose monohydrate was added (Addition of crystalline -lactose monohydrate to the infant food improved the flow propeties of the powder while reducing hygroscopicity of the product.    Spray drying was carrried out with inlet air at 210oc and outlet air at 90oc.. The product called  “Maternalized Infant Formula” (MIF) contained about  12.0% proteins, 26% fat, 56 % carbohydrates, 2.43% minerals and 2.68% moisture.. </div>
                <div className="earlylifepara" >Rao, 1986 (35)   dwelled  on the devlopment of a spray dried  food made from skimmed Bufallo milk for pre-term infants. These workers reported a biological value of about 91.8 for the infant food. . Rao, 1986 (36) and Rao and Mathur, 1987a,b (38,39) studied the effect of  preheating  milk to 95oC or 110oC on the physical properties of the infant food prepared from such milk. Chandrashekara et al, 1957 (10) had noted the effects of preheating milk on curd tension. Rao and Mathur, 1987c,d, (40) reported changes in solubility of protein on preheating the milk to 95oC or 110oC. They noted a decrease in content of non protein nitrogen and absence of albumin in the preheated samples as compared with that in raw milk.   Rao and Mathur, 1987d,e (41,42  (1987 )  reported changes in electrophoretic and ion exchnage chromatographic behaviour of proteins from preheated milk. kappa casein levels decreased and the amount of proteins eluting at higher strength of salt from proeins bound on to an ion exchange resin,. Thompkinson and Mathur, 1987 (43). Standardized the use of oil/buffalo butter blends to increase the level of unsaturated fatty acids in infant formula.</div>
                <div className="earlylifepara" >Two comphrensive reviews on Buffalo Milk (47,48) that have been recently published.</div>
                <br></br>
                <div className="earlylife" style={{ fontSize: 'large' }} >Dr.Waite: Visit and Suggestions</div>
                <br></br>
                <div className="earlylifepara" >Invovlement of the Hannah Research Station Ayr, Scotland in the Indian buffalo  milk processing scenari,o began with the visit of Norman C. Wright Director of Hannah Dairy Research institute, Ayhrshire Scotland. In  1937  he submitted a reported  regarding  the development of cattle and dairy industries of India (1). L.C.Sikka, member of the Milk Industries report (2) had  submitted a thesis for award of Ph.D while  at The Hannah Dairy Research Institute, Kirkhill, Ayr and writes that “I wish to express my grateful appreciation of the facilities afforded to me by the Council of the Hannah Dairy Research Institute, Kirkhill, Ayr. I am deeply Indebted to Dr. N.C. Wright and Dr. A.B. Fowler for their constant interest and valuable advice, and to Dr. R.A. Robb and Dr. J. Wishart for advice on statistical problems”.</div>
                <br></br>
                <div className="earlylifepara" >The milk report (2) mentions that the Central Food Technological Research  Insitute at Mysore had began investigations into on  malted milk and infant foods. The government of India had requested the help of an expert on dried milk foods and the FAO deputed Dr.R. Waite of the Hannah Research Centre, Airshire, Scotland for six weeks in December 1955</div>
                <br></br>
                <div className="earlylifepara" >Dr Waite had become an established authority on dried milk and, in 1955, on the invitation of the UN Food and Agriculture Organisation, he spent two months in India advising on a programme of research on the manufacture of invalid and infant foods (https://www.hannahdairyresearch.org.uk/hannah-dairy-research-history/). He visited the C.F.T.R.I. as well as different parts of the country and  made  the following recommendations a) that a small experimental factory be set up in a part of the country where buffalo and cows milk would not be required for supply to towns. b) Work to be carried out by the C.F.T.R.I. Mysore, Ministry of Food or any other place to reduce bacterial load during milk collection. C) The Anand spray drying plant, if agreed to by the Owners (Kaira Milk Producers Cooperative Society) should produce some infant food in collaboration with the C.F.T.R.I  who would “plan the composition” and examine the storability of the product.        d) The C.F.T.R.I. should work with both imported skim milk powder and with both cow’s and buffalo milk to produce infant foods using both roller drying and spray drying. e) The C.F.T.R.I. should work on a) the bacteriological content of milk and milk powder prepared by spray drying, roller drying and vaccum drying  b) On the curd tension of the raw, processed and dried bufallo milk powder c) using containers other than tin cans for storage of the milk powder d) tableting of fruit flavoured powder e) preparation of lactic acid milk powders. Nurtitive studies on a large number of children should be carried out in collaboration with the Indian Council of Medical Research or with those in the pratcise of medicine. These experiments should be be carried out when a bacteriologically safe powder has been manufactured at the Anand plant. The cocoa flavoured malted milk prepared at the C.F.T.R.I. should be devloped further. Lastly, the suggestion was made that a staff member associated with the project should be sent abroad  for some time after having worked on the problem of making infant food for a period of six months to a year. Chandraahekara visited NewZeland duirng that period and  published a paper detailing his reseaarches there in Richards and Chandrashekar (26).</div>
                <br></br>
                <div className="earlylifepara" >The paper on shelf life of the spray dried product (12) thanks “Dr.R.Waite of the Hannan Dairy Research Institute, Scotland” for his suggestions during a visit to  the C.F.T.R.I. as an F.A.O. expert particularly of  his help in the analysis of gases. Dr.Waite , visited the institute in December 1955.The importance of the Waite visit to C.F.T.R.I. is the manner in which the Howat et al (4) and  Leah et al (5) papers from the Hannah Research station had been studied and procedures therein followed. </div>
                <br></br>
                <div className="earlylifepara" >Thanks are due to Dr.N.Chandrashekar for meticulous editing of the manuscript. Dr. G.Ramanathan helped in editing as well in cross checking what was written. </div>
