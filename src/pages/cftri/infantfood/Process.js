    ...
    return (
        <>
            ...
            <div className="container" >
                ...
                <div className="earlylifepara" >It may be seen from the attached table that the largest reduction in curd tension was when partially skimmed and heated to <span>85{'\u00b0'}C</span> or so heated along with addition of either phosphate buffer or sodium citrate was added</div>
