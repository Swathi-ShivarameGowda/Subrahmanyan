...
import narayanarao from '../../../img/narayanarao.png'
    ...
    return (
        <>
            ...
            <div className="container" >
                ...
                <br></br>
                <div className="earlylife" style={{ fontSize: 'larger' }} >H.A.B.Parpia (1922-2013)(2)</div>
                <br></br>
